...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr valign="bottom">
		<td nowrap>
		  <img src="${root}/img/board/btn_write_01.gif" 
		  width="64" height="22" class="writeBtn"
...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	<tr class="posting" article-no="${article.seq }">
		...
		<span>${article.subject.replace("<", "&lt;") }</span>
		</td>
		<td></td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr valign="top">
		...
		<td width="100%" align="center">${navigator.navigator }</td>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		</select> <span id="sear1"> <input type="text" id="sword" name="word" size="22"
